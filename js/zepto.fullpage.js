(function($, window, undefined) {
    ...
    $.extend(Fullpage.prototype, {
        ...
        movePrev: function(anim,index) {
            this.moveTo(this.curIndex - 1, anim);
        },
        moveNext: function(anim) {
            this.moveTo(this.curIndex + 1, anim);
        },
        forward: function(anim,index) {
            this.moveTo(this.curIndex + index, anim);
        },
        back: function(anim) {
            this.moveTo(this.curIndex - 2, anim);
        }
    });
    ...
    //暴漏方法
    $.each(['update', 'moveTo', 'moveNext', 'movePrev','forward','back', 'start', 'stop'], function(key, val) {
